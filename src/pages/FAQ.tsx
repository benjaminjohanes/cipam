...
const faqCategories = [
  {
    ...
    questions: [
      {
        question: "Qu'est-ce que CIPAM ?",
        answer: "CIPAM (Centre International de Psychologie Appliquée Multidisciplinaire) est une plateforme dédiée à la psychologie pratique. Nous mettons en relation des usagers avec des professionnels qualifiés, proposons des formations en psychologie et offrons des services de consultation en ligne et en présentiel."
      },
      {
      ...
      },
      {
        ...
        answer: "Oui, CIPAM est accessible dans le monde entier. Nos professionnels peuvent proposer des consultations en ligne (vidéo) ce qui permet un accompagnement à distance, peu importe votre localisation géographique."
      }
    ]
  },
  {
    ...
    questions: [
      {
        question: "Comment créer un compte sur CIPAM ?",
      ...
      },
      {
        ...
        answer: "CIPAM propose trois types de comptes : Usager (pour accéder aux consultations et services), Étudiant (pour proposer des services supervisés et suivre des formations), et Professionnel (pour offrir des services, formations et consultations de manière autonome)."
      },
      {
        question: "Y a-t-il un âge minimum pour s'inscrire ?",
        answer: "Oui, vous devez avoir au moins 18 ans pour créer un compte sur CIPAM. Cette restriction est en place pour garantir la conformité légale et la protection des utilisateurs."
      },
      {
  ...
  },
  {
    ...
    questions: [
      ...
      {
        question: "Où trouver plus d'informations sur CIPAM ?",
